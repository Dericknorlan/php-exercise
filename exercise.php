<?php
    ...
    echo "Hello World"; // (no 1) 1 Baris Hello World
    echo "<br><br>";
    
    echo "<strong>10 Baris Hello World: </strong><br>";
    for($i = 1; $i <= 10; $i++) {
        echo "Hello World<br>"; // (no 2) 10 Baris Hello World
        }
    echo "<br><br>";
    
    echo "<strong>10 Baris Hello World Dengan Nomor Baris di Angka Genap: </strong><br>";
    for($i = 1; $i <= 10; $i++) {
        echo 'Hello World'. (($i % 2 == 0) ? (' - '. $i) : '') .'<br>'; // (no 3)10 Baris Hello World dengan Nomor Baris Ketika Genap
        }
    echo "<br><br>";
    ...
    foreach($NamaBulan as $Bulan) {
        echo $Bulan . "<br>"; // (no 4) Tampilkan Nama Bulan
    }
    echo "<br><br>";
    ...
    foreach($Arr2D as $Tanggal) {
        echo $Tanggal[0] ." - ". $Tanggal[1] ."<br>"; //(no 5) Tampilkan Nama Bulan dan Hari Libur
    }
    echo "<br><br>";
